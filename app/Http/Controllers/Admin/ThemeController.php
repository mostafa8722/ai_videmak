...
class ThemeController extends Controller
{
    ...
    {   
        $theme = $this->extensions->install($slug);

        if ($theme == 200) {
            toastr()->success(__('Theme has been successfully installed'));
        } else {
            toastr()->error(__('There was an issue with theme installation, please reach out to the support team'));
        }
