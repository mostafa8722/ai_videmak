    ...
    <div class="container-fluid"> 
        <div class="d-flex">
            <a class="header-brand" href="<?php echo e(url('/')); ?>">
                <img src="<?php echo e(theme_url('img/brand/logo.png')); ?>" class="header-brand-img desktop-lgo" alt="Polly logo">
...
<!-- END TOP MENU BAR -->
<?php /**PATH /home/videmak/public_html/resources/views/default/layouts/dashboard/nav-top.blade.php ENDPATH**/ ?>