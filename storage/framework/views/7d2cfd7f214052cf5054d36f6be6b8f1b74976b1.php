...
<aside class="app-sidebar"> 
    <div class="app-sidebar__logo">
        <a class="header-brand" href="<?php echo e(url('/')); ?>">
            <img src="<?php echo e(theme_url('img/brand/logo.png')); ?>" class="header-brand-img desktop-lgo" alt="Dashboard Logo">
            <img src="<?php echo e(theme_url('img/brand/favicon.png')); ?>" class="header-brand-img mobile-logo" alt="Dashboard Logo">
        </a>
    </div>
...
<!-- END SIDE MENU BAR --><?php /**PATH /home/videmak/public_html/resources/views/default/layouts/dashboard/nav-aside.blade.php ENDPATH**/ ?>