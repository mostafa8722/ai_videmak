<div class="row no-gutters">
    <nav class="navbar navbar-expand-lg navbar-light w-100" id="navbar-responsive">
        <a class="navbar-brand" href="<?php echo e(url('/')); ?>"><img id="brand-img"  src="<?php echo e(theme_url('img/brand/logo.png')); ?>" alt=""></a>
...
</div><?php /**PATH E:\projects\laravel\2024\Emmanuel\new_videmak\resources\views/default/frontend/menu/section.blade.php ENDPATH**/ ?>