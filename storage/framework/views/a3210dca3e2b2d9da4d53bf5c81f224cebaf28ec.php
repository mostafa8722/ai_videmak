...
<script type="text/javascript">
    ...
    if (myCookie == 'dark') {
            ...
            logo.src = '<?php echo e(theme_url('img/brand/logo-white.png')); ?>';
    }
    ...
    btn.addEventListener("click", function() {
        if (document.body.classList.contains('light-theme')) {
            ...
            document.querySelector(".btn-theme-toggle > span").classList.add("fa-sun-bright");
            var logo = document.querySelector(".desktop-lgo");
            logo.src = '<?php echo e(theme_url('img/brand/logo.png')); ?>';
            var theme = "dark";
...
<?php endif; ?><?php /**PATH /home/videmak/public_html/resources/views/default/layouts/dashboard/footer.blade.php ENDPATH**/ ?>