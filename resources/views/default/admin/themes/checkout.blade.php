				...
				<div class="card-body">
					<div class="row">	
						...
						<div class="col-lg-4 col-md-5 col-sm-12">
							<form id="payment-form" action="{{ route('admin.theme.purchase', $theme['slug']) }}" method="POST" enctype="multipart/form-data">
								@csrf
								<div class="card shadow-0 theme">								
										...
										<div class="theme-action text-center mt-4 mb-4">
											...
											@else
												@if ($extension->purchased)
													<a href="{{ route('admin.theme.install', $theme['slug']) }}" class="btn btn-primary ripple" style="width: 250px; text-transform: none; font-size: 11px; padding-top: 10px; padding-bottom: 10px;">{{ __('Install Theme') }}</a>	
												@else
